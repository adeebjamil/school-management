  ...
  const loadTimetable = async () => {
    try {
      ...
      if (err.response?.status === 404) {
        setError('No class assignment found');
      } else {
    ...
    >
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Weekly schedule for your classes</p>
        </div>
          ...
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-gray-600">
                Your class timetable will appear here once it's created by the administration.
              </p>
            </CardContent>
          </Card>
        ) : (
